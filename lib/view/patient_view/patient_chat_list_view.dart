...
import 'package:project_uaf/services/chat_list_service.dart';
...
class PatientChatListView extends StatefulWidget {
  const PatientChatListView({super.key});

  @override
  State<PatientChatListView> createState() => _PatientChatListViewState();
}

class _PatientChatListViewState extends State<PatientChatListView> {
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) => ChatView(
          nurseId: item.userId,
          patientId: myUid,
          nurseProfilePic: item.profileImageUrl,
          nurseName: item.name,
        ),
      ),
    );
